...
import { submitFeedback } from '../../Services/operations/Feedback'
...
const FeedbackForm = () => {
  ...
  const Submitdata = async (data) => {
    ...
    setLoading(false)
    if (result.success) {
      reset({ firstName: "", lastName: "", Email: "", countrycode: "", number: "", Message: "" })
    }
  }
