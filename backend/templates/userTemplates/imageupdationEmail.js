const imageUpdationEmail = (username,imageUrl) => {
	...
	<body>
		<div class="container">
			<div class="message">The user  profile is been updates</div>
			<div class="body">
				<p>Dear User,</p>
				<p>Dear user ${username} your profile image was has been updated</p>
				<p>The new updated image is </p>
                <img src=${imageUrl} alt ="new updated image" height="100" width="100">
			</div>
