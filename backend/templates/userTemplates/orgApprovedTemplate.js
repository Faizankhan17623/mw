const orgApprovedTemplate = (username) => {
	return `<!DOCTYPE html>
	<html lang="en">
	<head>
		<meta charset="UTF-8">
		...
		<title>Account Approved - Cine Circuit</title>
		<style>
			/* Reset */
			body, table, td, a {
					...
					<td align="center">
						<div class="email-container">
							...
							<div class="success-section">
								...
								<p class="success-subtitle">Your organizer account has been approved</p>
							</div>
							...
							<div class="content">
								<p class="greeting">
									...
									Great news! Your organizer verification request on <strong style="color: #e50914;">Cine Circuit</strong>
									has been reviewed and <strong style="color: #2ecc71;">approved</strong> by our admin team.
									You now have full access to the organizer dashboard and all its features.
								</p>
							</div>
							...
							<div class="status-section">
								<div class="status-card">
									<span class="status-badge">&#10003; &nbsp; Verified Organizer</span>
									<p class="status-text">Your account is now verified and active. You can start managing shows, theatres, and more.</p>
								</div>
							</div>
							...
							<div class="next-section">
								<div class="next-card">
									<div class="next-header">
										<p class="next-header-text">What You Can Do Now</p>
									</div>
									<div class="next-body">
										<div class="step-item">
											<div class="step-number"><span class="step-badge">1</span></div>
											<div class="step-text">Create and manage <strong style="color: rgba(255,255,255,0.8);">movie shows</strong> with full details, cast, and trailers</div>
										</div>
										<div class="step-item">
											<div class="step-number"><span class="step-badge">2</span></div>
											<div class="step-text">Allot your shows to <strong style="color: rgba(255,255,255,0.8);">verified theatres</strong> across the platform</div>
										</div>
										<div class="step-item">
											<div class="step-number"><span class="step-badge">3</span></div>
											<div class="step-text">Track <strong style="color: rgba(255,255,255,0.8);">ticket sales</strong> and revenue from your organizer dashboard</div>
										</div>
										<div class="step-item">
											<div class="step-number"><span class="step-badge">4</span></div>
											<div class="step-text">Manage <strong style="color: rgba(255,255,255,0.8);">cast, hashtags, and show metadata</strong> for better discoverability</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="info-section">
								<div class="info-box">
									<p>
										...
										Start by creating your first show and adding cast members. The more complete
										your show details, the better it will appear in search results and recommendations.
									</p>
								</div>
							</div>
