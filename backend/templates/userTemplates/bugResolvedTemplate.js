const bugResolvedTemplate = (bugId, title, adminNote, userName) => {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Bug Resolved — Cine Circuit</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .resolved-banner { background: linear-gradient(135deg, #0a1f0a 0%, #0d2a0d 100%); border: 1px solid #1a5c1a; border-radius: 12px; padding: 20px 28px; margin-bottom: 28px; text-align: center; }
    .resolved-icon { font-size: 36px; margin-bottom: 8px; }
    .resolved-text { font-size: 18px; font-weight: 700; color: #4caf50; letter-spacing: 1px; }
    .resolved-sub { font-size: 12px; color: #5a9e5a; margin-top: 4px; }
    ...
    .admin-note { background: rgba(76,175,80,0.07); border: 1px solid rgba(76,175,80,0.25); border-radius: 10px; padding: 18px 22px; margin-bottom: 28px; }
    .admin-note-label { font-size: 10px; color: #4caf50; letter-spacing: 3px; text-transform: uppercase; margin-bottom: 10px; }
    .admin-note-text { font-size: 14px; color: #bbb; line-height: 1.7; border-left: 3px solid #4caf50; padding-left: 12px; }
    ...
    .divider { height: 1px; background: linear-gradient(90deg, transparent, #2a2a2a, transparent); margin: 20px 0; }
  ...
  <div class="wrapper">
    <div class="card">
      ...
      <div class="body">
        ...
        <div class="subtitle">
          Your bug report has been reviewed and resolved by our admin team. Thank you for helping us improve Cine Circuit — your contribution makes the platform better for everyone.
        </div>

        <div class="resolved-banner">
          <div class="resolved-icon">🎉</div>
          <div class="resolved-text">Bug Successfully Resolved</div>
          <div class="resolved-sub">Our team has fixed the issue you reported</div>
        </div>

        <div class="id-box">
          <div class="id-label">Bug Report ID</div>
        ...
        <div class="info-box">
          <p>
            If you still experience this issue or find related problems, feel free to <span>submit a new bug report</span> from your dashboard. We're always here to help.
          </p>
        </div>
      </div>
      <div class="footer">
...
module.exports = bugResolvedTemplate
