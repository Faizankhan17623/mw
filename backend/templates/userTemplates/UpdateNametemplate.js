const updateNameTemplate = (oldusername,username) => {
	...
	<body>
		<div class="container">
			<div class="message">The user  profile name is been updates</div>
			<div class="body">
				<p>Dear User,</p>
				<p>Dear user ${oldusername} your username is   been updated</p>
				<p>The new updated username ${username} </p>
			</div>
