const orgRejectedTemplate = (username, editDate, editTime, attemptsLeft) => {
	return `<!DOCTYPE html>
	<html lang="en">
	<head>
		<meta charset="UTF-8">
		...
		<title>Verification Update - Cine Circuit</title>
		<style>
			/* Reset */
			body, table, td, a {
					...
					<td align="center">
						<div class="email-container">
							...
							<div class="content">
								...
								<p class="subtitle">Your organizer application needs some changes</p>
								<p class="greeting">
									Hi${username ? ' <strong style="color: #ffffff;">' + username + '</strong>' : ''},<br><br>
									We've reviewed your organizer verification request on <strong style="color: #e50914;">Cine Circuit</strong>
							...
							<div class="status-section">
								<div class="status-card">
									...
									<p class="status-text">Your application needs revisions before it can be approved. Please review and update your details within the given window.</p>
								</div>
							</div>
							...
							<div class="window-section">
								<div class="window-card">
									<div class="window-header">
										<p class="window-header-text">Your Edit Window</p>
									</div>
									<div class="window-body">
										<div class="window-row">
											<span class="window-icon">&#128197;</span>
											<span class="window-label">Edit Before Date</span>
											<span class="window-value">${editDate || 'N/A'}</span>
										</div>
										<div class="window-row">
											<span class="window-icon">&#128336;</span>
											<span class="window-label">Edit Before Time</span>
											<span class="window-value">${editTime || 'N/A'}</span>
										</div>
										<div class="window-row">
											<span class="window-icon">&#9888;&#65039;</span>
											<span class="window-label">Attempts Remaining</span>
											<span class="window-value danger">${attemptsLeft !== undefined ? attemptsLeft : 'N/A'}</span>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="steps-card">
									...
									<div class="steps-body">
										...
										<div class="step-item">
											...
											<div class="step-text">Go to your <strong style="color: rgba(255,255,255,0.8);">organizer profile</strong> and review all the details</div>
										</div>
										<div class="step-item">
											<div class="step-number"><span class="step-badge">3</span></div>
											<div class="step-text">Update and correct the required information before the deadline</div>
										</div>
										<div class="step-item">
											<div class="step-number"><span class="step-badge">4</span></div>
											<div class="step-text">Submit your profile again for <strong style="color: rgba(255,255,255,0.8);">re-verification</strong></div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="warning-section">
								<div class="warning-box">
									<p>
										...
										You have a limited number of attempts. After 3 failed attempts, your account will be
										locked for 2 months. Make sure to provide accurate and complete information.
										If you need help, <a href="mailto:faizankhan901152@gmail.com">contact our support team</a>.
									</p>
								</div>
							</div>
